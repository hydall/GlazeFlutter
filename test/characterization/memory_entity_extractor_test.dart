...
void main() {
  group('MemoryEntityExtractor (Phase G3)', () {
    ...
    test('extracts locations by suffix', () {
      ...
      final locations = entities.where((e) => e.entityType == 'location').toList();
    ...
    test('extracts locations by locative phrase', () {
      ...
      expect(entities.any((e) => e.entityType == 'location' && e.name == 'Crantmere'), isTrue);
    });
    ...
    test('first name alias for multi-word names', () {
      ...
      final pulchra = entities.firstWhere(
        (e) => e.name == 'Pulchra Fellini',
      );
