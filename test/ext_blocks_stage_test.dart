...
void main() {
  ...
  test(
    'disabled ExtBlocks skips the post-gen stage without publishing status',
    () async {
      ...
      await container
          ...
          .update(
            const ExtensionsSettings(enabled: false, activePresetId: 'p1'),
          );
      ...
      expect(service.processCalls, isZero);
      expect(
