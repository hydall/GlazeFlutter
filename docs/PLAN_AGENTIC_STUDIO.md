...
- [ ] **Consolidation:** `docs/PLAN_PIPELINE_SEPARATION.md:252-277` помечает consolidation как "scaffolded but not wired". Решить, входит ли wiring consolidation в этот план или отдельным.
