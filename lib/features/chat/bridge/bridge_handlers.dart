...
const Map<String, HandlerSpec> bridgeHandlers = {
  ...
  'onHeaderBack': HandlerSpec(HandlerKind.noArgs),
  'onHeaderSearch': HandlerSpec(HandlerKind.noArgs),
  ...
  'onInputSend': HandlerSpec(HandlerKind.jsonObject),
  'onInputStop': HandlerSpec(HandlerKind.noArgs),
  'onInputImpersonate': HandlerSpec(HandlerKind.noArgs),
  'onInputDraftChanged': HandlerSpec(HandlerKind.stringArg),
  'onInputFocus': HandlerSpec(HandlerKind.boolArg),
  'onKeyboardInset': HandlerSpec(HandlerKind.jsonObject),
  'onFullScreenEditor': HandlerSpec(HandlerKind.stringArg),
  'onMagicDrawer': HandlerSpec(HandlerKind.noArgs),
  'onQuickReplies': HandlerSpec(HandlerKind.noArgs),
  'onSearchNext': HandlerSpec(HandlerKind.noArgs),
  'onSearchPrev': HandlerSpec(HandlerKind.noArgs),
  'onCancelSelection': HandlerSpec(HandlerKind.noArgs),
  'onHideSelected': HandlerSpec(HandlerKind.noArgs),
  'onDeleteSelected': HandlerSpec(HandlerKind.noArgs),
  'onScrollToBottomTap': HandlerSpec(HandlerKind.noArgs),
};
