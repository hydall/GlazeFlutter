                ...
                children: [
                  ...
                  if (s.imageContextEnabled)
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text('Context images:', style: TextStyle(color: context.colors.textSecondary, fontSize: 13)),
...
class _TextFieldRowState extends State<_TextFieldRow> {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(
      children: [
        SizedBox(width: 100, child: Text(widget.label, style: TextStyle(fontSize: 13, color: context.colors.textSecondary))),
        Expanded(
          child: TextField(
...
class _DropdownRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(
      children: [
        SizedBox(width: 100, child: Text(label, style: TextStyle(fontSize: 13, color: context.colors.textSecondary))),
        Expanded(
      ...
      children: providers.map((p) {
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isSelected ? context.colors.accent.withValues(alpha: 0.15) : Colors.white.withValues(alpha: 0.04),
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: isSelected ? context.colors.accent : Colors.white.withValues(alpha: 0.1)),
            ),
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              Icon(p.$3, size: 16, color: isSelected ? context.colors.accent : context.colors.textSecondary),
              const SizedBox(width: 6),
              Text(p.$2, style: TextStyle(fontSize: 13, color: isSelected ? context.colors.accent : context.colors.textSecondary, fontWeight: isSelected ? FontWeight.w600 : FontWeight.normal)),
            ]),
          ),
        );
      }).toList(),
