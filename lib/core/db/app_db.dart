    ...
    onUpgrade: (Migrator m, int from, int to) async {
      ...
      if (from < 61) {
        ...
        try {
          ...
          debugPrint(
            'Migration 61 (telegraphic tracker format) failed: $e',
          );
        }
      }
      if (from < 62) {
      ...
      if (from < 63) {
        ...
        try {
          ...
          const oldCap = 'MAX 6 paragraphs per reply. 4-5 is ideal. 7+ is ALWAYS wrong.';
          const newCap = 'MAX 12 paragraphs per reply. 6-10 is ideal. 13+ is ALWAYS wrong.';
          for (final row in presets) {
            ...
            for (final b in blocks) {
              ...
              if (map['id'] == 'final_prose_style_anime' &&
                ...
                map['content'] =
                    (map['content'] as String).replaceAll(oldCap, newCap);
                changed = true;
                break;
              }
            }
