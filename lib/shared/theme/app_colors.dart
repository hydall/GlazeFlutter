...
class AppColors {
  // Glaze CSS design tokens
  static const Color background = Color(0xFF19191A); // --app-bg (#19191a)
  ...
  static const Color border = Color(0xFF2C2D2E); // --border-color
  // rgba(255,255,255,0.1) — glass element border
