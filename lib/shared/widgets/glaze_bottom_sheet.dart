                      ...
                      (a) => GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: Icon(
                            a.icon,
                            size: 22,
                            color: a.color ?? context.colors.textSecondary,
                          ),
                        ),
                      ),
                    )
                ...
                children: [
                  if (item.icon != null && !hasImage) ...[
                    Container(
                      ...
                      child: Icon(item.icon, size: 20, color: context.colors.accent),
                    ),
                    const SizedBox(width: 12),
                  ],
                  Expanded(
      ...
      children: [
            ...
            Flexible(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  fontWeight: FontWeight.w600,
                  color: hasImage ? Colors.white : context.colors.textPrimary,
                  shadows: hasImage
                ...
                child: Row(
                  children: [
                    Icon(
                      ...
                      size: 12,
                      color: hasImage ? Colors.white : context.colors.textSecondary,
                    ),
        ...
        if (item.sublabel != null) ...[
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 12,
              color: hasImage ? Colors.white70 : context.colors.textSecondary,
              shadows: hasImage
            ...
            (a) => GestureDetector(
              ...
              child: Container(
                ...
                child: Icon(
                  ...
                  color: hasImage
                      ? Colors.white
                       : (a.color ?? context.colors.textSecondary),
                ),
              ),
            ),
          )
